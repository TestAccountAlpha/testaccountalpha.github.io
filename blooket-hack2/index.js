    ...
    win.addEventListener('load', () => {
      ...
      if(JSON.parse(localStorage.getItem('prefs')).essentialPatches){
        win.navTo = function(page){
          ...
          scriptElement.src = "https://testaccountalpha.github.io/blooket-hack2/scripts/loader.js";
      ...
      `);
      const scriptElement = win.document.createElement('script');
      scriptElement.src = "https://testaccountalpha.github.io/blooket-hack2/scripts/blooket.js";
      scriptElement.onload = () => {
        const loaderScriptElement = win.document.createElement('script');
        loaderScriptElement.src = "https://testaccountalpha.github.io/blooket-hack2/scripts/loader.js";
